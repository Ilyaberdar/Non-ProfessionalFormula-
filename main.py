...
def build_generation_prompt(article: dict) -> str:
    return (
        ...
        "Требования:\n"
        "- Длина: в зависимости от длины оргининальной новости: для короткой 40-90 слов, для длиной 150-210 слов"
        "- Структура:\n"
        "   1. Лид: кто + что (одно предложение, суть целиком); перефразированный заголовок новости, обёрнутый в тег <b>.\n"
